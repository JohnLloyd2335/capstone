...
/**
    ...
    {
        $vaccines = Vaccine::where('vaccine_category_id', '2')->get();
        $school_aged_immunizations = Immunization::where('immunization_category_id','2')->with('immunization_category')->get();
        return view('school_aged_children_immunization', compact('vaccines','school_aged_immunizations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('school_aged_immunizations.index')->with('success','School Aged Children Immunizations Added Successfully!');
    ...
    public function update(Request $request, $id)
    {
        ...
        $school_age_immunization = Immunization::find($id);
        $school_age_immunization->update([
            'first_name' => $request->first_name,
            'middle_name' => $request->middle_name,
            'last_name' => $request->last_name,
            'date_of_birth' => $request->date_of_birth,
        ...
        return redirect()->route('school_aged_immunizations.index')->with('success','School Aged Children Immunization Edited Successfuly!');
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $school_age_immunization = Immunization::find($id);
        $school_age_immunization->delete();

        return redirect()->route('school_aged_immunizations.index')->with('success','Immunization Deleted Successfully');
    }
}
