...
class InfantImmunizationController extends Controller
{
    ...
    {
        $vaccines = Vaccine::where('vaccine_category_id', '1')->get();
        $infant_immunizations = Immunization::where('immunization_category_id','1')->with('immunization_category')->get();
        return view('infant_immunization', compact('vaccines','infant_immunizations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('infant_immunizations.index')->with('success','Infant Immunization Added Successfully!');
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Immunization $infant_immunization)
    {
        $request->validate([
            'first_name' => 'required',
            'middle_name' => 'required',
        ...
        return redirect()->route('infant_immunizations.index')->with('success','Infant Immunization Edited Successfuly!');
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Immunization $infant_immunization, Request $request)
    {
        $request->validate([
        ...
        $infant_immunization->delete();

        return redirect()->route('infant_immunizations.index')->with('success','Immunization Deleted Successfully');
    }
}
