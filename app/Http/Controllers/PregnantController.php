...
class PregnantController extends Controller
{
    ...
    {
        $vaccines = Vaccine::where('vaccine_category_id','3')->get();
        $pregnant_immunizations = Immunization::where('immunization_category_id','3')->with('immunization_category')->get();

        return view('pregnant_immunization', compact('vaccines','pregnant_immunizations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pregnant_immunizations.index')->with('success','Pregnant Immunizations Added Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $pregnant_immunization = Immunization::find($id);
        $pregnant_immunization->update([
            'first_name' => $request->first_name,
            'middle_name' => $request->middle_name,
            'last_name' => $request->last_name,
            'date_of_birth' => $request->date_of_birth,
        ...
        return redirect()->route('pregnant_immunizations.index')->with('success','Pregnant Immunization Edited Successfuly!');
