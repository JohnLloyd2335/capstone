...
class AdultController extends Controller
{
    ...
    {
        $vaccines = Vaccine::where('vaccine_category_id','4')->get();
        $adult_immunizations = Immunization::where('immunization_category_id','4')->with('immunization_category')->get();

        return view('adult_immunization',compact('vaccines','adult_immunizations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('adult_immunizations.index')->with('success','Adult Immunizations Added Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $adult_immunization = Immunization::find($id);
        $adult_immunization->update([
            'first_name' => $request->first_name,
            'middle_name' => $request->middle_name,
            'last_name' => $request->last_name,
            'date_of_birth' => $request->date_of_birth,
        ...
        return redirect()->route('adult_immunizations.index')->with('success','Adult Immunization Edited Successfuly!');
    ...
    public function destroy(Immunization $immunization, Request $request , $id)
    {
        ...
        $adult_immunization = Immunization::find($id);
        $adult_immunization->delete();

        return redirect()->route('adult_immunizations.index')->with('success','Adult Immunization Deleted Successfuly!');
    }
}
